...
from uprotocol_vsomeip.helper import VsomeipHelper
from uprotocol_vsomeip.vsomeip_utransport_backup import VsomeipTransport
...
someip = VsomeipTransport(helper=Helper(), source=UUri(ue_id=1, ue_version_major=1, resource_id=2))
